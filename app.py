...
def show_venue(venue_id):
  ...
  # upcoming_shows = [show for show in Show.query.filter(Show.start_time > datetime.datetime.now(), Show.venue_id == Show.id).all()]
  # past_shows = [show for show in Show.query.filter(Show.start_time < datetime.datetime.now(), Show.venue_id == Show.id).all()]
...
def create_venue_submission():
  try:
    ...
    if not 'seeking_description' in request.form == '':
...
def show_artist(artist_id):
  ...
  # upcoming_shows = [show for show in Show.query.filter(Show.start_time > datetime.datetime.now(), Show.artist_id == Show.artist_id).all()]
  # past_shows = [show for show in Show.query.filter(Show.start_time < datetime.datetime.now(), Show.artist_id == Show.id).all()]
